...
public class Human extends Race{
    ...
    private final int BASIC_STRENGTH = 5;
    private final int BASIC_DEXTERITY = 5;
    private final int BASIC_CONSTITUTION = 5;
    private final int BASIC_INTELLIGENCE = 5;
    ...
    private void validateLimit(int arg, int limit){
        if(arg > limit)
            throw new IllegalArgumentException("Arg must be lower than " + limit);
    }
